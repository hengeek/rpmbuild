Name:           openresty
Version:        1.19.9.1
Release:        1.dongbo%{?dist}
Packager:       https://github.com/dongbo
...
%define         SourceFile3     nginx.conf.dongbo
...
./configure \
    ...
    --with-threads \
    --with-compat \
    --add-module=/root/rpmbuild/SOURCES/openresty/modules/nginx-module-vts-0.2.2 \
...
ln -snf %{orprefix}/nginx/conf %{buildroot}/nginx_config
...
mkdir -p %{buildroot}%{orprefix}/nginx/conf/vhost/http
mkdir -p %{buildroot}%{orprefix}/nginx/conf/vhost/component
